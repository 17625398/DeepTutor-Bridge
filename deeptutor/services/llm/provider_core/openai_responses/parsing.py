...
from deeptutor.services.llm.provider_core.base import LLMResponse, ToolCallRequest, logger
        ...
        if event_type == "response.output_item.added":
            ...
            if item.get("type") == "function_call":
                ...
                try:
                    ...
                    args = json_repair.loads(args_raw) if json_repair is not None else {}
