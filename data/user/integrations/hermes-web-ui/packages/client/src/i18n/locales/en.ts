export default {
  ...
  settings: {
    ...
    connection: {
      ...
      remoteMode: 'Separated Deployment',
      serverUrl: 'Remote Server URL',
      serverUrlHint: 'Full URL of remote hermes-agent (including port)',
      serverUrlPlaceholder: 'http://192.168.0.39:8642',
      apiKey: 'API Key',
      apiKeyHint: 'Remote agent API Key (must match API_SERVER_KEY in config.yaml)',
      apiKeyPlaceholder: 'Enter API Key',
      show: 'Show',
      hide: 'Hide',
      localHint: 'Local mode: Web UI will automatically start local agent bridge, all requests are handled locally.',
