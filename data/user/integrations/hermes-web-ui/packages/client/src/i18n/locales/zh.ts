export default {
  ...
  settings: {
    ...
    connection: {
      ...
      remoteMode: '分离部署',
      serverUrl: '远程服务器地址',
      serverUrlHint: '远程 hermes-agent 的完整 URL（含端口）',
      serverUrlPlaceholder: 'http://192.168.0.39:8642',
      apiKey: 'API Key',
      apiKeyHint: '远程 agent 的 API Key（与 config.yaml 中的 API_SERVER_KEY 一致）',
      apiKeyPlaceholder: '输入 API Key',
      show: '显示',
      hide: '隐藏',
      localHint: '本地模式：Web UI 将自动启动本地 agent bridge，所有请求在本地处理。',
